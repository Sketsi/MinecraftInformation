...
public class MCEnchant extends MCCommand {
	...
	private boolean sendHelp(CommandSender sender, String command) {
		...
		switch (command) {
			case CommandType.INFO:
				sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&6MCInfo: &8Is that an enchantment? \"&6&o/mc &b&oenchant &e&oinfo &c&o<enchantment>&8\""));
				break;
			case CommandType.LIST:
			...
			default:
				sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&6Minecraft Information &bEnchant&6:"));
				sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&6/mc &benchant &einfo &c<enchantment> &8- &7Get information on an enchantment."));
				sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&6/mc &benchant &elist &a<[item]> &8- &7Lists all enchantments, if you specify item, it'll show specifics."));
